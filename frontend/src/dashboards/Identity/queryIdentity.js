            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <Card>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <CardActions style={styles.dialogActions}>
                    <Button size="medium" color="primary" onClick={this.register_file(this.state.files.acteNaissance)}>
                      Acte de naissance
                    </Button>
                  </CardActions>
                  <CardActions>
                ...
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  style={{ left: "7vw", marginBottom: "1vw" }}
                >
              ...
              <Card>
                ...
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  style={{ left: "3vw", marginBottom: "1vw" }}
                  onClick={() => this.handleOpenMedical(this.state.id)}
                >
                  Ajouter des données médicales
                </Button>
              </Card>
              <Card>
                <CardContent>
                ...
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  style={{ left: "8vw", marginBottom: "1vw" }}
                >
                  Ajouter un diplôme
                </Button>
                <br />
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  style={{ left: "9.5vw", marginBottom: "1vw" }}
                >
                  Ajouter un CV
                </Button>
              </Card>
            ...
            <Card>
              <CardContent>
                <Typography
                  ...
                  variant="h3"
                  gutterBottom
                  style={styles.dialogText.titleMed}
                >
